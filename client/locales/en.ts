...
export default <Dictionary>{
  ...
  'Reckonup is ....': 'Reckonup is ....',
  'You need to {0} or {1}.': 'You need to {0} or {1}.',
  'login': 'login',
  'signup': 'signup',
  ...
  // List page
  'Travel Expenditure List': 'Travel Expenditure List',
  '#': '#',
  ...
  'Holiday count': 'Holiday count',
  'Accomodation fee': 'Accomodation fee',
  'Transpotation fee': 'Transpotation fee',
  'Summary': 'Summary',
  'Save': 'Save',
  'Cancel': 'Cancel',
  'Saved!': 'Saved!',
